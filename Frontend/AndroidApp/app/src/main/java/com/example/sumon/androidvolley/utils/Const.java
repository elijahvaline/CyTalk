...
public class Const {
	...
	public static final String POST_OBJECT = "https://api.androidhive.info/volley/person_object.json";
	public static final String URL_JSON_ARRAY = "https://api.androidhive.info/volley/person_array.json";
	public static final String URL_STRING_REQ = "https://2db66630-0bd6-4ef6-ac3d-8170b4b8a10f.mock.pstmn.io/test";
